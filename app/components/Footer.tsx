      ...
      <div className="container" style={{ padding: '64px 24px 48px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 48 }}>
          ...
          <div style={{ gridColumn: 'span 1' }}>
            ...
            <p style={{ fontSize: '0.85rem', color: 'white', lineHeight: 1.75, maxWidth: 260 }}>
              ...
              {['linkedin', 'twitter', 'instagram'].map((s) => (
                <a key={s} href="#" aria-label={s}
                  style={{
                    ...
                    border: '1px solid rgba(184,150,62,0.3)', color: 'white',
                  ...
                  onMouseLeave={(e) => { (e.currentTarget as HTMLAnchorElement).style.borderColor='rgba(184,150,62,0.3)'; (e.currentTarget as HTMLAnchorElement).style.color='white'; }}
                >
                  {s[0].toUpperCase()}
                </a>
              ))}
          ...
          <div>
            ...
            <ul style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              {[
                ...
                <li key={l.label}>
                  <Link href={l.href} style={{ fontSize: '0.83rem', color: 'white', transition: 'color 0.2s', textDecoration: 'none' }}
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              <div>
                <p style={{ fontSize: '0.72rem', fontWeight: 700, color: 'white', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: 4 }}>Office (PA)</p>
                <p style={{ fontSize: '0.83rem', color: 'white', lineHeight: 1.65 }}>307 Fieldbrook Dr<br/>Pittsburgh, PA 15288</p>
              </div>
              <div>
                <p style={{ fontSize: '0.72rem', fontWeight: 700, color: 'white', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: 4 }}>Communication (NJ)</p>
                <p style={{ fontSize: '0.83rem', color: 'white', lineHeight: 1.65 }}>64 4th Street<br/>Wood Ridge, NJ 07075</p>
              </div>
              <div>
                <a href="mailto:sales@vizoraoptics.com" style={{ fontSize: '0.83rem', color: 'white', WebkitBackgroundClip: 'text', backgroundClip: 'text',  textDecoration: 'none', display: 'inline' }}>Sales@vizoraoptics.com</a><br/>
                <a href="mailto:vizoraoptics@gmail.com" style={{ fontSize: '0.83rem', color: 'white', textDecoration: 'none' }}>Vizoraoptics@gmail.com</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div style={{ borderTop: '1px solid rgba(255,255,255,0.06)', padding: '100px 0 60px', position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1, height: '100%' }}>
          ...
          <div style={{ display: 'flex', gap: 16, alignItems: 'center', position: 'absolute', top: 0, left: 0 }}>
            {/* Facebook */}
            <a href="#" aria-label="Facebook" style={{ width: 20, height: 20, display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', transition: 'color 0.2s' }} onMouseEnter={(e) => { (e.currentTarget as HTMLAnchorElement).style.color = '#1e88e5'; }} onMouseLeave={(e) => { (e.currentTarget as HTMLAnchorElement).style.color = 'white'; }}>
              <svg viewBox="0 0 24 24" fill="currentColor" style={{ width: 18, height: 18 }}>
                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
              </svg>
            </a>
            {/* Instagram */}
            <a href="#" aria-label="Instagram" style={{ width: 20, height: 20, display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', transition: 'color 0.2s' }} onMouseEnter={(e) => { (e.currentTarget as HTMLAnchorElement).style.color = '#1e88e5'; }} onMouseLeave={(e) => { (e.currentTarget as HTMLAnchorElement).style.color = 'white'; }}>
              <svg viewBox="0 0 24 24" fill="currentColor" style={{ width: 18, height: 18 }}>
            ...
            {/* X (Twitter) */}
            <a href="#" aria-label="X" style={{ width: 20, height: 20, display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', transition: 'color 0.2s' }} onMouseEnter={(e) => { (e.currentTarget as HTMLAnchorElement).style.color = '#1e88e5'; }} onMouseLeave={(e) => { (e.currentTarget as HTMLAnchorElement).style.color = 'white'; }}>
              <svg viewBox="0 0 24 24" fill="currentColor" style={{ width: 18, height: 18 }}>
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
              </svg>
            </a>
            {/* LinkedIn */}
            <a href="#" aria-label="LinkedIn" style={{ width: 20, height: 20, display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', transition: 'color 0.2s' }} onMouseEnter={(e) => { (e.currentTarget as HTMLAnchorElement).style.color = '#1e88e5'; }} onMouseLeave={(e) => { (e.currentTarget as HTMLAnchorElement).style.color = 'white'; }}>
              <svg viewBox="0 0 24 24" fill="currentColor" style={{ width: 18, height: 18 }}>
          ...
          {/* Copyright - top right */}
          <p style={{ fontSize: '0.75rem', color: 'white', margin: 0, position: 'absolute', top: 0, right: 0 }}>
